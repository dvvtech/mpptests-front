...
- **Блок выбора теста:**
  ...
  - Фон превью: серый (#9ca3af) для прозрачных PNG
...
### Выбор тестов
- Тест представляет собой черно-белое изображение в формате PNG в вертикальном формате. Изображения прозрачные, фон у них должен быть чуть сероватым цвета #9ca3af.
